...
import ResultModal from '../components/focus/ResultModal';
...
function Dashboard(props) {
  ...
  const completeChallenge = (completedChallenges) => {
    // toggleResultModal(!resultModal)
  }

    return (
      <div className="dashboard-content">
        <ResultModal profile={props.profile} show={resultModal} toggleResultModal={toggleResultModal}/>
         <Row>
           <Col sm={9}>         
               <div className="dashboard-focus">
               <FocusView user={user} profile={profile} updateProfile={updateProfile} challenges={challenges}/>
               </div>
           </Col>
           <Col sm={3}>
             <div className="dashboard-side">
                <SideView user={user} profile={profile} updateProfile={updateProfile} completeChallenge={completeChallenge} challenges={challenges}/>
             </div>
           </Col>
         </Row>
       </div>
